...
public class LoginController {
	...
	/*
	 * TODO [Step 1-2-2] LoginController.java 메소드 추가하기 웹을 통해 들어오는 url 은
	 * loginProcess1.do 이며 Get/Post 형식으로 넘어온다. 두가지를 다받는 메소드를 만들어보자. 또
	 ...
	 * 
	 * TODO [Step 1-4-1] LoginController.java 에서 loginProcess 메소드 수정하기.
	 * Validator 이용하여 값 검증하기
	 */
